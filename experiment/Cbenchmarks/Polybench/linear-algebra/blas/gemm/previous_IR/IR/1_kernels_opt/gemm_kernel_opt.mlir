module attributes {adora.scheduled} {
  func.func @gemm(%arg0: memref<?x25xf32>, %arg1: memref<?x30xf32>, %arg2: memref<?x25xf32>) attributes {adora.dep_summary = [{block_idx = 0 : i64, edges = [{dst = 2 : i64, kind = "RAW", overlap = true, src = 1 : i64}, {dst = 2 : i64, kind = "RAW", overlap = true, src = 0 : i64}, {dst = 3 : i64, kind = "RAW", overlap = true, src = 2 : i64}, {dst = 3 : i64, kind = "RAW", overlap = true, src = 1 : i64}, {dst = 8 : i64, kind = "RAW", overlap = true, src = 6 : i64}, {dst = 8 : i64, kind = "RAW", overlap = true, src = 5 : i64}, {dst = 8 : i64, kind = "RAW", overlap = true, src = 4 : i64}, {dst = 8 : i64, kind = "RAW", overlap = true, src = 7 : i64}, {dst = 9 : i64, kind = "RAW", overlap = true, src = 8 : i64}, {dst = 9 : i64, kind = "RAW", overlap = true, src = 7 : i64}, {dst = 9 : i64, kind = "WAR", overlap = true, src = 4 : i64}, {dst = 9 : i64, kind = "WAW", overlap = true, src = 3 : i64}, {dst = 4 : i64, kind = "RAW", overlap = true, src = 3 : i64}, {dst = 9 : i64, kind = "WAR", overlap = true, src = 0 : i64}, {dst = 4 : i64, kind = "RAR", overlap = true, src = 0 : i64}, {dst = 3 : i64, kind = "WAR", overlap = true, src = 0 : i64}]}], adora.lc_dep_summary = [{edges = [{exact = false, kind = "LC-RAR", step = 1 : i64}, {exact = false, kind = "LC-WAR", step = 1 : i64}, {exact = false, kind = "LC-RAR", step = 1 : i64}, {exact = false, kind = "LC-WAR", step = 1 : i64}, {exact = false, kind = "LC-RAW", step = 1 : i64}, {exact = false, kind = "LC-WAW", step = 1 : i64}, {exact = false, kind = "LC-RAW", step = 1 : i64}, {exact = false, kind = "LC-WAW", step = 1 : i64}, {exact = false, kind = "LC-RAR", step = 1 : i64}, {exact = false, kind = "LC-WAR", step = 1 : i64}, {exact = false, kind = "LC-RAR", step = 1 : i64}, {exact = false, kind = "LC-WAR", step = 1 : i64}, {exact = false, kind = "LC-RAR", step = 1 : i64}, {exact = true, kind = "LC-RAR", step = 1 : i64}, {exact = false, kind = "LC-RAW", step = 1 : i64}, {exact = false, kind = "LC-WAW", step = 1 : i64}, {exact = false, kind = "LC-RAW", step = 1 : i64}, {exact = false, kind = "LC-WAW", step = 1 : i64}], loop_idx = 0 : i64, loop_op = "affine.for"}], llvm.linkage = #llvm.linkage<external>} {
    ...
    %12:12 = affine.for %arg3 = 0 to 20 iter_args(%arg4 = %0, %arg5 = %1, %arg6 = %2, %arg7 = %3, %arg8 = %4, %arg9 = %5, %arg10 = %6, %arg11 = %7, %arg12 = %8, %arg13 = %9, %arg14 = %10, %arg15 = %11) -> (!ADORA.token, !ADORA.token, !ADORA.token, !ADORA.token, !ADORA.token, !ADORA.token, !ADORA.token, !ADORA.token, !ADORA.token, !ADORA.token, !ADORA.token, !ADORA.token) {
      ...
      %18 = ADORA.BlockStore async [%17, %asyncToken_2, %15, %asyncToken, %arg5, %arg9, %arg11, %arg15] %16, %arg0 [%arg3, 0] : memref<1x25xf32> -> memref<?x25xf32>  {Id = "3", KernelName = "gemm_1"} -> !ADORA.token
  ...
  func.func @gemm_opt(%arg0: memref<?x25xf32>, %arg1: memref<?x30xf32>, %arg2: memref<?x25xf32>) attributes {adora.dep_summary = [{block_idx = 0 : i64, edges = [{dst = 2 : i64, kind = "RAW", overlap = true, src = 1 : i64}, {dst = 2 : i64, kind = "RAW", overlap = true, src = 0 : i64}, {dst = 3 : i64, kind = "RAW", overlap = true, src = 2 : i64}, {dst = 3 : i64, kind = "RAW", overlap = true, src = 1 : i64}, {dst = 7 : i64, kind = "RAW", overlap = true, src = 6 : i64}, {dst = 7 : i64, kind = "RAW", overlap = true, src = 5 : i64}, {dst = 7 : i64, kind = "RAW", overlap = true, src = 4 : i64}, {dst = 8 : i64, kind = "RAW", overlap = true, src = 7 : i64}, {dst = 8 : i64, kind = "RAW", overlap = true, src = 4 : i64}, {dst = 8 : i64, kind = "WAW", overlap = true, src = 3 : i64}, {dst = 4 : i64, kind = "RAW", overlap = true, src = 3 : i64}, {dst = 8 : i64, kind = "WAR", overlap = true, src = 4 : i64}, {dst = 8 : i64, kind = "WAR", overlap = true, src = 0 : i64}, {dst = 3 : i64, kind = "WAR", overlap = true, src = 0 : i64}, {dst = 4 : i64, kind = "RAR", overlap = true, src = 0 : i64}]}], llvm.linkage = #llvm.linkage<external>} {
    %cst = arith.constant 1.200000e+00 : f32
    %cst_0 = arith.constant 1.500000e+00 : f32
    ...
    %1 = ADORA.kernel async [%asyncToken] {
      affine.for %arg3 = 0 to 20 {
        affine.for %arg4 = 0 to 25 {
          %4 = affine.load %result[%arg3, %arg4] : memref<20x25xf32>
          %5 = arith.mulf %4, %cst : f32
          affine.store %5, %0[%arg3, %arg4] : memref<20x25xf32>
        }
      }
      ADORA.terminator
    ...
    %3 = ADORA.kernel async [%asyncToken_6, %asyncToken_4, %asyncToken_2] {
      affine.for %arg3 = 0 to 20 {
        affine.for %arg4 = 0 to 30 {
          affine.for %arg5 = 0 to 25 {
            %4 = affine.load %result_3[%arg3, %arg4] : memref<20x30xf32>
            %5 = arith.mulf %4, %cst_0 : f32
            %6 = affine.load %result_5[%arg4, %arg5] : memref<30x25xf32>
            %7 = arith.mulf %5, %6 : f32
            %8 = affine.load %result_1[%arg3, %arg5] : memref<20x25xf32>
            %9 = arith.addf %8, %7 : f32
            affine.store %9, %result_1[%arg3, %arg5] : memref<20x25xf32>
          }
        }
      }
      ADORA.terminator
    } {KernelName = "gemm_opt_1"}
    ADORA.BlockStore async [%3, %asyncToken_2, %2, %asyncToken] %result_1, %arg0 [0, 0] : memref<20x25xf32> -> memref<?x25xf32>  {Id = "0", KernelName = "gemm_opt_1"}
    return
  }
}
