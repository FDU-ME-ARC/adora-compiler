module attributes {adora.scheduled} {
  ...
  func.func @gemm_opt(%arg0: memref<?x25xf32>, %arg1: memref<?x30xf32>, %arg2: memref<?x25xf32>) attributes {adora.dep_summary = [{block_idx = 0 : i64, edges = [{dst = 2 : i64, kind = "RAW", overlap = true, src = 1 : i64}, {dst = 2 : i64, kind = "RAW", overlap = true, src = 0 : i64}, {dst = 3 : i64, kind = "RAW", overlap = true, src = 2 : i64}, {dst = 3 : i64, kind = "RAW", overlap = true, src = 1 : i64}, {dst = 7 : i64, kind = "RAW", overlap = true, src = 5 : i64}, {dst = 7 : i64, kind = "RAW", overlap = true, src = 4 : i64}, {dst = 7 : i64, kind = "RAW", overlap = true, src = 6 : i64}, {dst = 8 : i64, kind = "RAW", overlap = true, src = 4 : i64}, {dst = 8 : i64, kind = "RAW", overlap = true, src = 7 : i64}, {dst = 8 : i64, kind = "WAR", overlap = true, src = 4 : i64}, {dst = 8 : i64, kind = "WAW", overlap = true, src = 3 : i64}, {dst = 4 : i64, kind = "RAW", overlap = true, src = 3 : i64}, {dst = 8 : i64, kind = "WAR", overlap = true, src = 0 : i64}, {dst = 4 : i64, kind = "RAR", overlap = true, src = 0 : i64}, {dst = 3 : i64, kind = "WAR", overlap = true, src = 0 : i64}]}], llvm.linkage = #llvm.linkage<external>} {
    %cst = arith.constant 1.200000e+00 : f32
    %cst_0 = arith.constant 1.500000e+00 : f32
    ...
    %3 = ADORA.kernel async [%asyncToken_4, %asyncToken_2, %asyncToken_6] {
      affine.for %arg3 = 0 to 20 {
    ...
    ADORA.BlockStore async [%asyncToken_2, %3, %2, %asyncToken] %result_1, %arg0 [0, 0] : memref<20x25xf32> -> memref<?x25xf32>  {Id = "0", KernelName = "gemm_opt_1"}
    return
  }
}
