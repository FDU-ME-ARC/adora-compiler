...
module {
  ...
  func.func @Conv_0(%arg0: memref<1x3x32x32xf32>, %arg1: memref<16x3x3x3xf32>, %arg2: memref<16xf32>) -> memref<1x16x32x32xf32> attributes {adora_kernel, llvm.emit_c_interface} {
    ...
    %alloc_0 = memref.alloc() : memref<1024x27xf32>
    affine.for %arg3 = 0 to 1 {
      affine.for %arg4 = 0 to 3 {
          ...
          affine.for %arg6 = 0 to 3 {
            affine.for %arg7 = 0 to 32 {
              affine.for %arg8 = 0 to 32 {
                %0 = affine.apply #map(%arg7, %arg5)
                %1 = affine.apply #map(%arg8, %arg6)
                %2 = affine.load %alloc[%arg3, %arg4, %0, %1] : memref<1x3x34x34xf32>
                %3 = affine.apply #map1(%arg3, %arg7, %arg8)
                %4 = affine.apply #map2(%arg4, %arg5, %arg6)
                affine.store %2, %alloc_0[%3, %4] : memref<1024x27xf32>
              }
            }
          }
        }
    ...
    %alloc_1 = memref.alloc() : memref<27x16xf32>
      ...
      affine.for %arg4 = 0 to 3 {
        affine.for %arg5 = 0 to 3 {
          affine.for %arg6 = 0 to 3 {
            ...
            affine.store %0, %alloc_1[%1, %arg3] : memref<27x16xf32>
          }
        }
      }
    }
    %alloc_2 = memref.alloc() : memref<1024x16xf32>
    affine.for %arg3 = 0 to 1024 {
      affine.for %arg4 = 0 to 16 {
        %0 = affine.load %arg2[%arg4] : memref<16xf32>
        affine.store %0, %alloc_2[%arg3, %arg4] : memref<1024x16xf32>
      }
    }
    %alloc_3 = memref.alloc() : memref<1024x16xf32>
    memref.copy %alloc_2, %alloc_3 : memref<1024x16xf32> to memref<1024x16xf32>
    affine.for %arg3 = 0 to 27 step 9 {
      affine.for %arg4 = 0 to 1024 step 256 {
        affine.for %arg5 = 0 to 16 step 16 {
          %0 = ADORA.BlockLoad %alloc_0 [%arg4, %arg3] : memref<1024x27xf32> -> memref<64x4xf32> , stride [4, 1] {ADORAGemm, Id = "0", KernelName = "GEMMIS", Pingpong}
          %1 = ADORA.BlockLoad %alloc_0 [%arg4, %arg3 + 4] : memref<1024x27xf32> -> memref<64x4xf32> , stride [4, 1] {ADORAGemm, Id = "1", KernelName = "GEMMIS", Pingpong}
          %2 = ADORA.BlockLoad %alloc_0 [%arg4, %arg3 + 8] : memref<1024x27xf32> -> memref<64x1xf32> , stride [4, 1] {ADORAGemm, Id = "2", KernelName = "GEMMIS", Pingpong}
          %3 = ADORA.BlockLoad %alloc_0 [%arg4 + 1, %arg3] : memref<1024x27xf32> -> memref<64x4xf32> , stride [4, 1] {ADORAGemm, Id = "3", KernelName = "GEMMIS", Pingpong}
          %4 = ADORA.BlockLoad %alloc_0 [%arg4 + 1, %arg3 + 4] : memref<1024x27xf32> -> memref<64x4xf32> , stride [4, 1] {ADORAGemm, Id = "4", KernelName = "GEMMIS", Pingpong}
          %5 = ADORA.BlockLoad %alloc_0 [%arg4 + 1, %arg3 + 8] : memref<1024x27xf32> -> memref<64x1xf32> , stride [4, 1] {ADORAGemm, Id = "5", KernelName = "GEMMIS", Pingpong}
          %6 = ADORA.BlockLoad %alloc_0 [%arg4 + 2, %arg3] : memref<1024x27xf32> -> memref<64x4xf32> , stride [4, 1] {ADORAGemm, Id = "6", KernelName = "GEMMIS", Pingpong}
          %7 = ADORA.BlockLoad %alloc_0 [%arg4 + 2, %arg3 + 4] : memref<1024x27xf32> -> memref<64x4xf32> , stride [4, 1] {ADORAGemm, Id = "7", KernelName = "GEMMIS", Pingpong}
          %8 = ADORA.BlockLoad %alloc_0 [%arg4 + 2, %arg3 + 8] : memref<1024x27xf32> -> memref<64x1xf32> , stride [4, 1] {ADORAGemm, Id = "8", KernelName = "GEMMIS", Pingpong}
          %9 = ADORA.BlockLoad %alloc_0 [%arg4 + 3, %arg3] : memref<1024x27xf32> -> memref<64x4xf32> , stride [4, 1] {ADORAGemm, Id = "9", KernelName = "GEMMIS", Pingpong}
          %10 = ADORA.BlockLoad %alloc_0 [%arg4 + 3, %arg3 + 4] : memref<1024x27xf32> -> memref<64x4xf32> , stride [4, 1] {ADORAGemm, Id = "10", KernelName = "GEMMIS", Pingpong}
          %11 = ADORA.BlockLoad %alloc_0 [%arg4 + 3, %arg3 + 8] : memref<1024x27xf32> -> memref<64x1xf32> , stride [4, 1] {ADORAGemm, Id = "11", KernelName = "GEMMIS", Pingpong}
          %12 = ADORA.BlockLoad %alloc_1 [%arg3, %arg5] : memref<27x16xf32> -> memref<1x16xf32>  {ADORAGemm, Id = "12", KernelName = "GEMMIS", Pingpong}
          %13 = ADORA.BlockLoad %alloc_1 [%arg3 + 1, %arg5] : memref<27x16xf32> -> memref<1x16xf32>  {ADORAGemm, Id = "13", KernelName = "GEMMIS", Pingpong}
          %14 = ADORA.BlockLoad %alloc_1 [%arg3 + 2, %arg5] : memref<27x16xf32> -> memref<1x16xf32>  {ADORAGemm, Id = "14", KernelName = "GEMMIS", Pingpong}
          %15 = ADORA.BlockLoad %alloc_1 [%arg3 + 3, %arg5] : memref<27x16xf32> -> memref<1x16xf32>  {ADORAGemm, Id = "15", KernelName = "GEMMIS", Pingpong}
          %16 = ADORA.BlockLoad %alloc_1 [%arg3 + 4, %arg5] : memref<27x16xf32> -> memref<1x16xf32>  {ADORAGemm, Id = "16", KernelName = "GEMMIS", Pingpong}
          %17 = ADORA.BlockLoad %alloc_1 [%arg3 + 5, %arg5] : memref<27x16xf32> -> memref<1x16xf32>  {ADORAGemm, Id = "17", KernelName = "GEMMIS", Pingpong}
          %18 = ADORA.BlockLoad %alloc_1 [%arg3 + 6, %arg5] : memref<27x16xf32> -> memref<1x16xf32>  {ADORAGemm, Id = "18", KernelName = "GEMMIS", Pingpong}
          %19 = ADORA.BlockLoad %alloc_1 [%arg3 + 7, %arg5] : memref<27x16xf32> -> memref<1x16xf32>  {ADORAGemm, Id = "19", KernelName = "GEMMIS", Pingpong}
          %20 = ADORA.BlockLoad %alloc_1 [%arg3 + 8, %arg5] : memref<27x16xf32> -> memref<1x16xf32>  {ADORAGemm, Id = "20", KernelName = "GEMMIS", Pingpong}
          %21 = ADORA.BlockLoad %alloc_3 [%arg4, %arg5] : memref<1024x16xf32> -> memref<64x16xf32> , stride [4, 1] {ADORAGemm, Id = "21", KernelName = "GEMMIS", Pingpong}
          %22 = ADORA.LocalMemAlloc memref<64x16xf32>  {ADORAGemm, Id = "22", KernelName = "GEMMIS", Pingpong}
          %23 = ADORA.BlockLoad %alloc_3 [%arg4 + 1, %arg5] : memref<1024x16xf32> -> memref<64x16xf32> , stride [4, 1] {ADORAGemm, Id = "23", KernelName = "GEMMIS", Pingpong}
          %24 = ADORA.LocalMemAlloc memref<64x16xf32>  {ADORAGemm, Id = "24", KernelName = "GEMMIS", Pingpong}
          %25 = ADORA.BlockLoad %alloc_3 [%arg4 + 2, %arg5] : memref<1024x16xf32> -> memref<64x16xf32> , stride [4, 1] {ADORAGemm, Id = "25", KernelName = "GEMMIS", Pingpong}
          %26 = ADORA.LocalMemAlloc memref<64x16xf32>  {ADORAGemm, Id = "26", KernelName = "GEMMIS", Pingpong}
          %27 = ADORA.BlockLoad %alloc_3 [%arg4 + 3, %arg5] : memref<1024x16xf32> -> memref<64x16xf32> , stride [4, 1] {ADORAGemm, Id = "27", KernelName = "GEMMIS", Pingpong}
          ...
          ADORA.BlockStore %22, %alloc_3 [%arg4, %arg5] : memref<64x16xf32> -> memref<1024x16xf32> , stride [4, 1] {ADORAGemm, Id = "22", KernelName = "GEMMIS", Pingpong}
          ADORA.BlockStore %24, %alloc_3 [%arg4 + 1, %arg5] : memref<64x16xf32> -> memref<1024x16xf32> , stride [4, 1] {ADORAGemm, Id = "24", KernelName = "GEMMIS", Pingpong}
          ADORA.BlockStore %26, %alloc_3 [%arg4 + 2, %arg5] : memref<64x16xf32> -> memref<1024x16xf32> , stride [4, 1] {ADORAGemm, Id = "26", KernelName = "GEMMIS", Pingpong}
          ADORA.BlockStore %28, %alloc_3 [%arg4 + 3, %arg5] : memref<64x16xf32> -> memref<1024x16xf32> , stride [4, 1] {ADORAGemm, Id = "28", KernelName = "GEMMIS", Pingpong}
        } {ADORAGemm}
      } {ADORAGemm}
    } {ADORAGemm}
    %alloc_4 = memref.alloc() : memref<1x16x32x32xf32>
    affine.for %arg3 = 0 to 1 {
      affine.for %arg4 = 0 to 16 {
        affine.for %arg5 = 0 to 32 {
          affine.for %arg6 = 0 to 32 {
            %0 = affine.apply #map1(%arg3, %arg5, %arg6)
            %1 = affine.load %alloc_3[%0, %arg4] : memref<1024x16xf32>
            affine.store %1, %alloc_4[%arg3, %arg4, %arg5, %arg6] : memref<1x16x32x32xf32>
          }
        }
      }
    }
    return %alloc_4 : memref<1x16x32x32xf32>
  }
}
