module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "onnx-mlir.symbol-postfix" = "ffn_bf16"} {
  ...
  func.func @Gemm_0(%arg0: memref<64x128xbf16>, %arg1: memref<128x256xbf16>, %arg2: memref<64x256xbf16>) -> memref<64x256xbf16> attributes {adora_kernel, llvm.emit_c_interface} {
    %0 = "ADORATensor.Gemm"(%arg0, %arg1, %arg2) : (memref<64x128xbf16>, memref<128x256xbf16>, memref<64x256xbf16>) -> memref<64x256xbf16>
  ...
  func.func @Gemm_1(%arg0: memref<64x256xbf16>, %arg1: memref<256x128xbf16>, %arg2: memref<64x128xbf16>) -> memref<64x128xbf16> attributes {adora_kernel, llvm.emit_c_interface} {
    %0 = "ADORATensor.Gemm"(%arg0, %arg1, %arg2) : (memref<64x256xbf16>, memref<256x128xbf16>, memref<64x128xbf16>) -> memref<64x128xbf16>
