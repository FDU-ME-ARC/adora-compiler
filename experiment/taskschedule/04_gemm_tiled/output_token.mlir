    ...
    affine.for %arg3 = 0 to 4 {
      affine.for %arg4 = 0 to 4 {
        ...
        %3:3 = affine.for %arg5 = 0 to 4 iter_args(%arg6 = %0, %arg7 = %1, %arg8 = %2) -> (!ADORA.token, !ADORA.token, !ADORA.token) {
          %result, %asyncToken = ADORA.BlockLoad async [%arg7] %arg2 [%arg3 * 16, %arg4 * 16] : memref<64x64xf32> -> memref<16x16xf32>  {Id = "0", KernelName = "gemm_tiled_tk"} -> !ADORA.token
          ...
          %6 = ADORA.BlockStore async [%5, %asyncToken, %arg6, %arg8] %4, %arg2 [%arg3 * 16, %arg4 * 16] : memref<16x16xf32> -> memref<64x64xf32>  {Id = "3", KernelName = "gemm_tiled_tk"} -> !ADORA.token
