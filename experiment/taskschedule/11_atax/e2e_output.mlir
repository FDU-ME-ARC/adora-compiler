module attributes {adora.scheduled} {
  func.func @atax(%arg0: memref<390x410xf32>, %arg1: memref<410xf32>, %arg2: memref<410xf32>, %arg3: memref<390xf32>) attributes {adora.dep_summary = [{block_idx = 0 : i64, edges = []}], llvm.linkage = #llvm.linkage<external>} {
