module attributes {adora.scheduled} {
  func.func @ffn_fc1(%arg0: memref<?x32xi32>, %arg1: memref<?x64xi32>, %arg2: memref<?x64xi32>) attributes {adora.dep_summary = [], llvm.linkage = #llvm.linkage<external>} {
  ...
  func.func @ffn_fc2(%arg0: memref<?x64xi32>, %arg1: memref<?x32xi32>, %arg2: memref<?x32xi32>) attributes {adora.dep_summary = [], llvm.linkage = #llvm.linkage<external>} {
    %c16 = arith.constant 16 : index
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %c32 = arith.constant 32 : index
  ...
  func.func @ffn(%arg0: memref<?x32xi32>, %arg1: memref<?x64xi32>, %arg2: memref<?x32xi32>, %arg3: memref<?x64xi32>, %arg4: memref<?x32xi32>) attributes {adora.dep_summary = [], llvm.linkage = #llvm.linkage<external>} {
    %c16 = arith.constant 16 : index
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %c64 = arith.constant 64 : index
