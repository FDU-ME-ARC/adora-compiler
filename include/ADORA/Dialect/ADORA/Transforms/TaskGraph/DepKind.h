...
// schema version.
//===----------------------------------------------------------------------===//
#ifndef ADORA_DIALECT_ADORA_TRANSFORMS_TASKGRAPH_DEPKIND_H_
#define ADORA_DIALECT_ADORA_TRANSFORMS_TASKGRAPH_DEPKIND_H_
...
inline llvm::StringRef toString(DataBlockDepKind k) {
  ...
  // Unreachable for a well-formed enum value; keep a stable fallback so the
  // attribute never carries an empty string.
  return "UNK";
}
...
#endif // ADORA_DIALECT_ADORA_TRANSFORMS_TASKGRAPH_DEPKIND_H_
