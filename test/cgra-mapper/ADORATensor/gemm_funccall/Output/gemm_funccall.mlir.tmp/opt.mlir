...
module attributes {adora.scheduled} {
  func.func @matmul_0(%arg0: memref<32x128xbf16>, %arg1: memref<128x64xbf16>, %arg2: memref<32x64xbf16>) -> memref<32x64xbf16> attributes {adora.dep_summary = [], llvm.emit_c_interface} {
  ...
  func.func @Gemm_0(%arg0: memref<32x128xbf16>, %arg1: memref<128x64xbf16>, %arg2: memref<32x64xbf16>) -> memref<32x64xbf16> attributes {adora.dep_summary = [], adora_kernel, llvm.emit_c_interface} {
