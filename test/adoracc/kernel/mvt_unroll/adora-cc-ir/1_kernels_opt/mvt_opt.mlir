module {
  func.func @kernel_mvt(%arg0: memref<?xf32>, %arg1: memref<?xf32>, %arg2: memref<?xf32>, %arg3: memref<?xf32>, %arg4: memref<?x40xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %4 = ADORA.BlockLoad %arg1 [0] : memref<?xf32> -> memref<40xf32>  {Id = "4", KernelName = "kernel_mvt_1"}
    %5 = ADORA.BlockLoad %arg4 [0, 0] : memref<?x40xf32> -> memref<40x40xf32>  {Id = "5", KernelName = "kernel_mvt_1"}
    %6 = ADORA.BlockLoad %arg3 [0] : memref<?xf32> -> memref<40xf32>  {Id = "6", KernelName = "kernel_mvt_1"}
    %7 = ADORA.LocalMemAlloc memref<40xf32>  {Id = "7", KernelName = "kernel_mvt_1"}
    ADORA.kernel {
      affine.for %arg5 = 0 to 40 {
    ...
    ADORA.BlockStore %7, %arg1 [0] : memref<40xf32> -> memref<?xf32>  {Id = "7", KernelName = "kernel_mvt_1"}
    return
  }
}
