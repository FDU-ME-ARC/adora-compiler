...
// RUN: %FileCheck %s --check-prefix=DOT --input-file=cf_nested_CDFG.dot --implicit-check-not='opcode = "undefined"' --implicit-check-not='opcode = "CTRL'
// RUN: rm -f cf_nested_CDFG.dot
...
// DOT-DAG: CONST[[INNER_TRUE:[0-9]+]][opcode = "CONST", value="0x0000000B"
// DOT-DAG: CONST[[INNER_FALSE:[0-9]+]][opcode = "CONST", value="0x00000016"
// DOT-DAG: CONST[[OUTER_FALSE:[0-9]+]][opcode = "CONST", value="0x00000021"
...
// DOT-DAG: CONST[[OUTER_FALSE]] -> SEL[[OUTER]]{{[^]]*}}operand = 0, label = "Op=0"
// DOT: }
