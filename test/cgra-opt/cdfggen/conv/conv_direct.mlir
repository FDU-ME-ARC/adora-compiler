...
func.func @test_conv_direct(%arg0: memref<1x3x16x16xf32>, %arg1: memref<8x3x3x3xf32>, %arg2: memref<8xf32>) -> memref<1x8x16x16xf32> attributes {llvm.emit_c_interface, onnxEntryPoint} {
  ...
  } : (memref<1x3x16x16xf32>, memref<8x3x3x3xf32>, memref<8xf32>) -> memref<1x8x16x16xf32>
  
  return %0 : memref<1x8x16x16xf32>

  // =====================================================================
  // Verification 1: Ensure the global output matrix is pre-allocated
  // CHECK: %[[FINAL_RES:.*]] = memref.alloc() : memref<1x8x16x16xf32>

  // Verification 2: IFM mathematical derivation check (P=8 -> H_in=10)
  // CHECK: ADORA.BlockLoad %{{.*}} : memref<1x3x16x16xf32> -> memref<1x3x10x10xf32>
